...
with open("additional_chatgpt_descriptors_nabirds.json", "w") as outfile:
    outfile.write(json_object)

# %% ----POST PROCESSING----
additional_chatgpt_desc_path= "/home/tin/xclip/additional_chatgpt_descriptors_nabirds.json"
...
for mbird in missing_birds:
    ...
    # chatgpt
    chatgpt_desc_data[mbird][12] = shape_desc
    chatgpt_desc_data[mbird][13] = size_desc
    chatgpt_desc_data[mbird][14] = habitat_desc
