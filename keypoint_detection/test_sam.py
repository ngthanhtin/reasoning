...
# %%
# cfg
image_path = '/home/tin/datasets/cub/CUB//images/079.Belted_Kingfisher/Belted_Kingfisher_0006_70625.jpg' #args.image_path
relative_image_path = '079.Belted_Kingfisher/Belted_Kingfisher_0006_70625.jpg'

image_path = '/home/tin/datasets/cub/CUB//images/088.Western_Meadowlark/Western_Meadowlark_0063_77946.jpg' #args.image_path
relative_image_path = '088.Western_Meadowlark/Western_Meadowlark_0063_77946.jpg'

image_path = '/home/tin/datasets/cub/CUB/images/100.Brown_Pelican/Brown_Pelican_0095_94290.jpg' #args.image_path
...
color_dict = {
    ...
    'y': (0, 255, 255),       # Yellow
    'w': (255, 255, 255),     # White
    'tab:orange': (0, 165, 255),  # Orange
    'tab:purple': (128, 0, 128),  # Purple
    'tab:brown': (0, 139, 139),   # Brown
    'tab:pink': (203, 192, 255),  # Pink
    'tab:gray': (169, 169, 169),  # Gray
    'lime': (0, 255, 0),         # Lime
    'aqua': (255, 255, 0),       # Aqua
    ...
    if relative_image_path == relative_kp_key:
        ...
        for k, (part_name, xy) in enumerate(parts.items()):
            ...
            if part_name in ['beak']:
                ...
                input_point = np.array(copied_list_coords)
            ...
            plt.figure(figsize=(10,10))
            cv2.putText(orig_image, part_name, (box[0], box[1] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.1, bgr_colors[k], 1)
            cv2.rectangle(orig_image, (box[0], box[1]), (box[0] + box[2], box[1] + box[3]), bgr_colors[k], 2)
