...
from data_loader.augmentation import TrivialAugmentation
from data_loader.nabirds_horn import load_bounding_box_annotations, load_part_annotations, load_part_names, load_class_names, \
...
class NABirdsDataset(Dataset):
    ...
    def __init__(self, root_dir, transform=None, train = True, zeroshot_split = False, **kwargs):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform is not None:
            ...
            sample = self.transform(images=sample)
