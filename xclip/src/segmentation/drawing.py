...
def draw_text(img, text_list, text_size=14, text_color=None, inside=False):
    try:
        ...
        ft = ImageFont.truetype("/home/tin/projects/reasoning/xclip/src/segmentation/arial.ttf", text_size)
    # else:
    ...
    def draw_boxes(image, boxes, colors, tags=None, alpha=0.8, width=1, text_size=12, loc='above'):
        if tags is not None:
            try:
                ...
                font = ImageFont.truetype("/home/tin/projects/reasoning/xclip/src/segmentation/arial.ttf", text_size)
